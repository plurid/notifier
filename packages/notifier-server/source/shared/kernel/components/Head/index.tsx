...
const Head: React.FC<HeadProperties> = (
    ...
    const titleValue = title || `notifier`;
    const descriptionValue = description || 'Cloud-Native Notifier';
    const ogTitleValue = ogTitle || title || `notifier`;
    const ogDescriptionValue = ogDescription || description || 'Cloud-Native Notifier';
